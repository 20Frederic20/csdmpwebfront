...
export function AppSidebar() {
  ...
  return (
    <Sidebar collapsible="icon" variant="inset" className="border-r border-sidebar-border bg-sidebar shadow-sm">
      <SidebarHeader className="border-b border-sidebar-border py-4">
        <SidebarMenu>
          <SidebarMenuItem>
            <SidebarMenuButton size="lg" asChild className="hover:bg-sidebar-accent transition-colors">
              <Link href="/dashboard">
                <div className="flex aspect-square size-10 items-center justify-center rounded-xl bg-vital-green text-white vital-glow">
                  <Activity className="size-6" />
                </div>
                <div className="grid flex-1 text-left text-sm leading-tight ml-3">
                  <span className="truncate font-display font-bold text-lg tracking-tight text-foreground">CS<span className="text-vital-green">DMP</span></span>
                  <span className="truncate text-[10px] text-sidebar-foreground uppercase tracking-widest font-medium">Santé Connectée</span>
                </div>
              </Link>
            </SidebarMenuButton>
          </SidebarMenuItem>
